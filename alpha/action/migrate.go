...
func (m Migrate) Run(ctx context.Context) error {
	...
	return writeToFS(*cfg, m.OutputDir, m.WriteFunc, m.FileExt, m.SplitFiles)
}

func writeToFS(cfg declcfg.DeclarativeConfig, rootDir string, writeFunc WriteFunc, fileExt string, splitFiles bool) error {
